...
namespace OpenSoftware.OidcTemplate.Auth.Middlewares
{
    public class AuthServerApiExceptionHandlerMiddleware
    {
        private readonly RequestDelegate _next;
        private readonly ILogger<AuthServerApiExceptionHandlerMiddleware> _logger;
        private readonly DefaultContractResolver _contractResolver;
        private readonly IConfiguration _configuration;

        public AuthServerApiExceptionHandlerMiddleware(RequestDelegate next, ILogger<AuthServerApiExceptionHandlerMiddleware> logger, IConfiguration configuration)
        {
            _next = next;
            _logger = logger;
    ...
    public static class AuthServerApiExceptionHandlerExtensions
    {
        public static IApplicationBuilder UseAuthServerApiExceptionHandler(this IApplicationBuilder builder)
        {
            return builder.UseMiddleware<AuthServerApiExceptionHandlerMiddleware>();
        }
    }
}
